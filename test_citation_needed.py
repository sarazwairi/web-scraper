import pytest
from web_scraper.scraper import get_citation_needed_count,get_citation_needed_report

url ="https://en.wikipedia.org/wiki/History_of_Mexico"

def test_get_citation_needed_count():
    actual=get_citation_needed_count(url)
    expected=5
    assert actual==expected

def test_get_citation_needed_report():
    actual=get_citation_needed_report(url)
